...
function setupGeminiIpcHandlers(geminiSessionRef) {
    ...
    // COMMENTED OUT: Audio/video capture functionality disabled for WebSocket text-only mode
    /*
    ...
    */
    ...
    // COMMENTED OUT: macOS audio capture disabled for WebSocket text-only mode
    /*
